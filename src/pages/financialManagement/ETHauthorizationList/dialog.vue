<template>
  ...
  >
    <el-form label-width="150px" ref="formRef" :model="form">
      ...
      >
        <el-input v-model="form.payment_wallet_address" placeholder="" />
      </el-form-item>
      <el-form-item
    ...
    const submitDialog = (formRef) => {
      formRef.validate((valid) => {
        if (valid) {
          ...
          let params = {
            id: state.form.id,
            payment_wallet_address: state.form.payment_wallet_address,
            amount: parseFloat(state.form.amount),
          };
          http.financialManagement
            .editETHauthorization(params)
            .then((res) => {
    ...
    onUpdated(() => {
      ...
      if (props.data.hasOwnProperty("id")) {
        state.form = {
          ...
          payment_wallet_address: props.data.payment_wallet_address,
