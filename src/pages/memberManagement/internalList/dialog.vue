<template>
  ...
  >
    <el-form label-width="130px" ref="formRef" :model="form">
      ...
      >
        <el-input v-model="form.wallet_balance" placeholder="" type="number" />
      </el-form-item>
      ...
      <el-form-item :label="t('table.isAuth')">
        <el-radio-group v-model.number="form.is_authorized">
          <el-radio :label="2">{{ t("table.unauthorized") }}</el-radio>
          <el-radio :label="1">{{ t("table.authorized") }}</el-radio>
        </el-radio-group>
      </el-form-item>
