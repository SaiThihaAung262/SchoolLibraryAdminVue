<template>
  <div v-loading="isLoading">
    <div class="form" v-show="isShowSearch">
      ...
      <div class="form-content" v-permission="116">
    ...
    <div class="table" v-permission="116">
      <div class="top-panel">
        <div class="left">
          <el-button
            @click="addNew"
      ...
      >
        ...
        <el-table-column label="USDT" align="center" width="200">
          <template #default="scope">
        ...
        <el-table-column label="ETH" align="center" width="220">
          <template #default="scope">
            {{ t("common.total") }}:
            {{
        ...
        <!-- <el-table-column prop="id" label="代理" align="center" /> -->
      ...
      <!-- <el-table :data="walletBalanceList" :border="true">
        <el-table-column prop="totalBalance" label="" align="center">
          <template #default="scope">
            <p class="text">
              {{ t("common.totalWalletBalance") }} :
              <span class="value">
...
export default {
  ...
  setup() {
    ...
    const state = reactive({
      ...
      selectedExportLists: [],
      groupLists: [],
      walletBalanceList: [{ totalBalance: 100 }],
    ...
    const getTableList = () => {
      ...
      http.memberManagement.getMember(state.param).then((res) => {
    ...
    const sendETHhandler = (id) => {
      ElMessageBox.confirm(t("common.sureToGiveETH"), t("common.warning"), {
        ...
        .then(() => {
          console.log("Here is confit");
          http.memberManagement
            .sendGatewayEthMember({ user_id: id })
            .then((res) => {
              if (res.data.err_code == 0) {
    ...
    const sendTRXhandler = (id) => {
      ElMessageBox.confirm(t("common.sureToGiveTRX"), t("common.warning"), {
        ...
        .then(() => {
          http.memberManagement
            .sendGatewayTrxMember({ user_id: id })
            .then((res) => {
              if (res.data.err_code == 0) {
                ElMessage.success(res.data.err_msg);
                search();
